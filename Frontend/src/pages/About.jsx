      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to E-Auction platform, the ultimate destination for online auctions
            and bidding excitement. Founded in September 2024, we are dedicated to
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At E-Auction platform, our mission is to revolutionize the way people buy and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Shyam & Shivam , E-Auction for Vehicle was born out of a passion for
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing E-Auction platform. We look forward to being a part of
